...
namespace ChartApp.Actors {
  ...
  public class ButtonToggleActor : UntypedActor {
    ...
    public ButtonToggleActor(
      ActorRef coordinatorActor, Button myButton, CounterType myCounterType, bool isToggledOn = false ) {
    ...
    private void FlipToggle() {
      ...
      _myButton.Text = string.Format(
        "{0} ({1})", _myCounterType.ToString().ToUpperInvariant(), _isToggledOn ? "ON" : "OFF" );
    }
  }
}